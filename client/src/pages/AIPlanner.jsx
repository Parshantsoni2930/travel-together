...
const AIPlanner = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const aiReply =
        res.data.reply || "Sorry, I couldn't understand your request.";
      ...
      <div style={plannerContainer}>
        <div style={heroSection}>
          ...
          <div style={heroContent}>
            <span style={heroBadge}>AI • Smart Planning • Travel</span>

            <h1 style={heroTitle}>AI Trip Planner</h1>

            <p style={heroText}>
              Ask for itineraries, budget planning, places to visit, transport,
              hotels, routes, and hidden gems.
            </p>
          </div>
        </div>
        ...
        <div style={messagesBox}>
          {messages.map((msg, index) => (
            ...
            >
              <div
                style={{
                  ...bubbleStyle,
                  background: msg.role === "user" ? "#ffffff" : "#181818",
                  color: msg.role === "user" ? "#000000" : "#ffffff",
                  borderBottomRightRadius:
                    msg.role === "user" ? "4px" : "18px",
                  borderBottomLeftRadius:
                    msg.role === "user" ? "18px" : "4px",
                }}
              >
                {msg.text}
              </div>
          ...
          {loading && (
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              <div style={typingBubble}>AI is thinking...</div>
            </div>
          )}
